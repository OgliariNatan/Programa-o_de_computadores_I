...
int main()
{
    ...
    for (x=0; x<tam; x++){
        ...
        fflush(stdin);
        scanf("%d",&lista[x].ano);
        printf("\n%d. Digite o Preço do veiculo[R$](xxxxx):\t",(x+1));
        fflush(stdin);
